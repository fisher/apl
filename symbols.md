*Nota Bene*: work in progress (as of 2020.09.10)
...
Used to denote a negative number. Not the same as regular `-` (minus) sign. The difference is smooth, just think about monadic '-' sign as of a function, which negates the argument; while _high_ _negative_ _sign_ appyes to immediate literal, i.e. it cannot be appied to a variable and it is always monadic.
